...
#     "VST",
#     "OXY",
# ]  # new - 10April April2026 - commpleted Gridsearch 1h - no results
FILTER_SYMBOLS = ["FIGR", "AMD", "PANW", "PLTR", "APP", "DDOG"]
...
N_JOBS = 4  # for RUNPOD uses all CPU cores, or specify number (e.g., 8)
